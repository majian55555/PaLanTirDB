// newPage.h: interface for the newPage class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_NEWPAGE_H__31F70E79_52BC_46A8_9CB5_4AACE8A2742A__INCLUDED_)
#define AFX_NEWPAGE_H__31F70E79_52BC_46A8_9CB5_4AACE8A2742A__INCLUDED_

#include "error.h"
#include <vector>
const unsigned long PAGESIZE = 4*1024;
...
public:
	...
	const unsigned long getOffset(unsigned short idx) const
	{
		unsigned long offset=0;
		for(int i=0;i<idx;i++)
		{
			if(!this->attrsInPage[i].isNull())
				offset+=this->attrsInPage[i].getAttrLen();
		}
		return offset;
	}
};
...
#endif // !defined(AFX_NEWPAGE_H__31F70E79_52BC_46A8_9CB5_4AACE8A2742A__INCLUDED_)
