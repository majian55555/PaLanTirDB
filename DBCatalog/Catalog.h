...
public:
	AttrInfo():relName(),attrName(),attrType(0),attrInPage(),attrSize(0),attrValue(){}
	const std::string getRelName() const {return this->relName;}
	...
	const void* getAttrValue() const {return this->attrValue;}
...
public:
	AttrDesc():relName(),attrName(),attrIdx(0),attrType(0),attrSize(0){}
